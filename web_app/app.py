...
from engine_runner import (
    ...
    TREND_RESISTANCE_SHORT_ENABLED,
    TREND_SUPPORT_LONG_ENABLED,
    SR_PRO_LONG_V3_ENABLED,
    SR_PRO_LONG_V1_ENABLED,
    SR_PRO_LONG_V2_ENABLED,
    BB_REJECT_SHORT_1H3M_ENABLED,
...
COMMAND_DEFS = [
    ...
    {"cmd": "/trend_resistance_short", "key": "_trend_resistance_short_enabled", "label": "Trend Resistance Short", "type": "toggle"},
    {"cmd": "/trend_support_long", "key": "_trend_support_long_enabled", "label": "Trend Support Long", "type": "toggle"},
    {"cmd": "/sr_pro_long_v1", "key": "_sr_pro_long_v1_enabled", "label": "SR Pro Long V1", "type": "toggle"},
    {"cmd": "/sr_pro_long_v2", "key": "_sr_pro_long_v2_enabled", "label": "SR Pro Long V2", "type": "toggle"},
    {"cmd": "/sr_pro_long_v3", "key": "_sr_pro_long_v3_enabled", "label": "SR Pro Long V3", "type": "toggle"},
    {"cmd": "/bb_reject_long_1h3m", "key": "_bb_reject_short_1h3m_enabled", "label": "BB Reject Long 1h3m", "type": "toggle"},
...
DEFAULTS = {
    ...
    "_trend_resistance_short_enabled": TREND_RESISTANCE_SHORT_ENABLED,
    "_trend_support_long_enabled": TREND_SUPPORT_LONG_ENABLED,
    "_sr_pro_long_v3_enabled": SR_PRO_LONG_V3_ENABLED,
    "_sr_pro_long_v1_enabled": SR_PRO_LONG_V1_ENABLED,
    "_sr_pro_long_v2_enabled": SR_PRO_LONG_V2_ENABLED,
    "_bb_reject_short_1h3m_enabled": BB_REJECT_SHORT_1H3M_ENABLED,
