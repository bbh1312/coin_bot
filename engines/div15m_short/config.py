...
class Div15mShortConfig:
    ...
    # RSI
    RSI_LEN: int = 14
    MIN_RSI_DOWN: float = 4.0
    RSI_OB: float = 70.0
    OB_LOOKBACK_W: int = 6
    WARMUP_BARS: int = 50

    # Price
    MIN_HH_PCT: float = 0.004
    ...
    EMA_REGIME_SLOPE_LOOKBACK: int = 1

    # Trigger
    TRIGGER_MODE: str = "A"  # A: EMA20 close reject, B: break prev 3 lows
