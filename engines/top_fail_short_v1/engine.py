...
class TopFailShortV1Config:
    ...
    tf_mtf: str = "15m"
    tf_htf: str = "1h"
    universe_24h_change: float = 15.0
    ...
    ema_len: int = 30
    rsi_len: int = 14
    rsi_overbought_level: float = 60.0
    rsi_overbought_bars: int = 4
    vol_div_lookback: int = 3
    swing_lookback: int = 30
    atr_len: int = 14
    wash_atr_mult: float = 1.2
    vol_spike_mult: float = 1.6
    vol_sma_len: int = 20
    retest_ema_tol: float = 0.1
    limit_entry: bool = True
    limit_offset_atr: float = 0.15
    retest_max_depth_atr: float = 1.3
    retest_wait_next_high: bool = False
    fail_wick_max: float = 0.35
